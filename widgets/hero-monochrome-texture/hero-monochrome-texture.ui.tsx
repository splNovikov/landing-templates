...
import { useMonochromeTexture } from './use-monochrome-texture';
import styles from './hero-monochrome-texture.module.css';

export interface HeroMonochromeTextureProps {
  topLabel?: string;
  title: string;
  subtitle: string;
  techFeatures?: Array<{
...
export function HeroMonochromeTexture({
  topLabel,
  title,
  subtitle,
  techFeatures,
  ...
  ctaHref,
  ctaOnClick,
}: HeroMonochromeTextureProps) {
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const containerRef = useRef<HTMLDivElement>(null);

  useMonochromeTexture(canvasRef, containerRef);
