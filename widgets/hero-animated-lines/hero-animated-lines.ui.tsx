...
import { useAnimatedLines } from './use-animated-lines';
import styles from './hero-animated-lines.module.css';

export interface HeroAnimatedLinesProps {
  topLabel?: string;
  title: string;
  subtitle: string;
  techFeatures?: Array<{
...
export function HeroAnimatedLines({
  ...
  ctaHref,
  ctaOnClick,
}: HeroAnimatedLinesProps) {
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const containerRef = useRef<HTMLDivElement>(null);

  useAnimatedLines(canvasRef, containerRef);
