...
import { useSubtleMesh } from './use-subtle-mesh';
import styles from './hero-subtle-mesh.module.css';

export interface HeroSubtleMeshProps {
  topLabel?: string;
  title: string;
  subtitle: string;
  techFeatures?: Array<{
...
export function HeroSubtleMesh({
  topLabel,
  title,
  subtitle,
  techFeatures,
  ...
  useSubtleMesh(canvasRef, containerRef);
